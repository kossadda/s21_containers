...
//  * @brief Binary red-black tree containers method testing module
//  * @version 1.0
//  * @date 2024-07-21
//  *
...
//   117,
//                     118, 60, 26,  1,  22, 66,  69,  77, 82,  88,  99,  80};
//   init_list erase = {60, 82, 66, 26, 22, 69, 1, 110, 118, 5, 99, 115, 116,
//   117}; tree t;
...
//   init_list list = {64, 44,  22,  112, 43, 33, 12,  5,   105, 211, 54,
//                     77, 222, 111, 1,   49, 91, 199, 202, 209, 228, 100};
//   init_list erase = {44, 64, 49, 100, 77, 111, 112, 5, 1, 33, 105, 91, 22,
//   54}; tree t;
